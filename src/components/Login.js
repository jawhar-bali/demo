...
const Login = () => {
  ...
  const handleSignInClick = () => {
    ...
    // Utiliser le hook navigate pour rediriger vers la page du composant Sidenav.js
    navigate('/connector'); // Assurez-vous d'avoir la route configurée dans votre application
  };
